...
def jax_dynamics(state, control, dt=default_dt):
    ...
    # 2. Calculate state derivative (State Derivative)
    # [dx, dy, dtheta, dv]
    # This writing style allows JAX to recognize it as a single vector operation
    state_dot = jnp.array([
        v * jnp.cos(theta),  # dx
        v * jnp.sin(theta),  # dy
        omega,               # dtheta 
...
# The Numpy version remains the same for debugging
