...
try:
    ...
    print("✅ RLtrain  loads successfully。")
...
class HierarchicalController:
    ...
    def _compile_functions(self):
        # [Modified] Had predict_loop return action a at the same time for ZOH initialization
...
def mppi_optimize_step(current_state, U_prev, rng_key, ref_traj, current_time, time_vars, real_reach_flags, noise_scale=1.0, weight_scale=1.0):
    ...
    def rollout_scan(carry, inputs):
        ...
        # [Modified] apply dynamic noise scaling
        ...
        # [Modified] Calculate tracking error using dynamic weights
...
def run_final_merged_ref_virtual():
    ...
    model_path = os.path.join(current_dir, "RLtrain/local_minima_trap_model_1balls.msgpack")
    ...
    print(f"🔒 RL planning time variables: {time_vars}")
   ...
   # === [Step 1] Initialize MPPI (ZOH) with RL action sequences ===
    ...
    for step in range(TOTAL_STEPS):
        ...
        # --- B. MPPI Control (50Hz) ---
        #  noise_scale=1.0, weight_scale=1.0
    ...
    # ==========================================
    print("\n📊 Sorting and saving simulation data...")
