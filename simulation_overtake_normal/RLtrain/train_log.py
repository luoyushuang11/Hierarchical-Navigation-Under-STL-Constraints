...
def plot_dynamic_overtaking(phys_trajs, scores, scenario, iter_idx, filename="dynamic_result.png"):
    ...
    plt.axhline(y=2.0, color='white', linestyle='--', linewidth=2) 
...
class TGPOTrainer:
    def __init__(self, seed=0, scenario_name="dynamic_overtaking"): 
        ...
        # 4. 规划组件 (Elite Buffer & STL Evaluator)
    ...
    def save_logs(self, filename="dynamic_training_logs.npz"):
        ...
        print(f"[Log] ✅ The dynamic scene training log has been fully saved to: {filename}")
