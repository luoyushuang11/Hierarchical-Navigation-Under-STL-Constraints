...
def sample_uniform_times(rng_key, n_samples, n_vars):
    """
    [Sim2Sim Optimization] samples only within the SAMPLING_WINDOWS (end window) defined by Config.
    """
    # [Modified] Read a dedicated sampling window instead of an STL window
