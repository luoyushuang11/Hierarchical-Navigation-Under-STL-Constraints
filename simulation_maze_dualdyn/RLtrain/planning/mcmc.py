...
def metropolis_hastings_sampling(rng_key, critic_apply_fn, critic_params, initial_states, current_times):
    ...
    # Read Sim2Sim-specific SAMPLING_WINDOWS (e.g. [120, 140])
    ...
    # 3. Define the MCMC step transfer function
    def mcmc_step(carry, _):
        ...
        # --- B. Constraints ---
        # B1. Absolute Window Constraints (Sim2Sim Core)
    ...
    # 4. [Fix point] Define init_carry (must be before lax.scan)
