...
def h_x_jax(x, t, time_vars, reach_flags):
    ...
    # --- Workspace boundary parameters [0, 12] x [0, 10] ---
    ...
    b_static = (dist_out + dist_in) - ROBOT_RADIUS-0.001

    # ==========================================
    # Part 2: 2 dynamic circular obstacles 
    # ==========================================
    ...
    # Status update: If the history is already true, or if the frame happens to be triggered, then update to true
